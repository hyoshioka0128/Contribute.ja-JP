...
## <a name="making-your-next-change"></a>次の変更を行う

この変更とは無関係な変更を加える必要がありますか。 マスター ブランチに戻り、アップストリーム リポジトリからプルして、フォークが最新の状態になっていることを確認し、新しいブランチをチェックアウトします。  Git Bash で次のコマンドを実行します。
...
これで完了です。 docs.microsoft.com のコンテンツを共同作成しました。
